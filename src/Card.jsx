  ...
  return (
    <div className="min-h-screen bg-stone-50 flex items-center justify-center p-8">
      <div className="relative bg-white border border-stone-200 rounded-xl max-w-sm w-full p-8 shadow-sm overflow-hidden">
        ...
        {/* Button */}
        <button className="group inline-flex items-center gap-2 text-[12px] font-medium tracking-[0.12em] uppercase text-[#B7935A] border border-[#B7935A] rounded-[2px] px-5 py-2.5 bg-transparent hover:bg-[#B7935A] hover:text-white transition-colors duration-150">
          Explore More
          <svg
